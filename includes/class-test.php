...
class Test {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $test    The string used to uniquely identify this plugin.
	 */
	protected $test;
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Test_Admin( $this->get_test(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Test_Public( $this->get_test(), $this->get_version() );
